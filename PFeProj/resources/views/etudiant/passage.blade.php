  ...
  <body>
    <script>
      document.addEventListener("visibilitychange", function()
      {
        ...
        {
          alert("Vous avez quitté le quiz !"); form.submit();
        }
          ...
          <div class="col-lg-2 background-white border-bottom border-light mt-3 ">
            ...
            <div class="icon-bar col-lg-3 border border-light rounded bg-warning " >
              <p class="text-white mt-3 ">
                ...
                Attention de quitter votre quiz , vous n'aurez plus le droit de y accéder ! </p>  <p class="btn  btn-enabled  bg-danger text-white" >Durée de l'examen : <span class="js-timeout"></span>  </p>
          </div>
            </div>
            </div>
          <div class=" col-lg-8 " >
              ...
              <div class="row">
                <div class="col-lg-10">
                 <button class="d-inline-flex h4 text-dark"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-file-text-fill mr-2" viewBox="0 0 16 16">
                  ...
                  <div class="col-lg-2">
                      <p>
                          Durée:    &nbsp; <span class="js-timeout " >1:00</span>
                      </p>
...
<button value="" class=" btn btn-primary" type="submit"  name="send">Terminé !</button>
</form>
                        </div>
                                                </div>
                           </div> 
    ...
    <script type="text/javascript">
        ...
        function countdown() {
          ...
          interval = setInterval( function() {
              ...
              if (minutes == 0 && seconds == 0) { clearInterval(interval);  form.submit(); alert("Quiz terminé !");}
          }, 1000);
        }
