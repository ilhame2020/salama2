...
<div class="col-lg-12">
  @if(Session::has('success'))
        ...
        @endif
                    ...
                    <div  class=" col-lg-12">
                        <form method="post" class="p-4 p-md-5 border border-danger  rounded-3  text-black font-weight-bold bg-light"  action="{{route('qr.createQr') }}" enctype="multipart/form-data" >
                            @csrf 
                          <div class="row">
                           <div class=" col-lg-10 ">
                             <button class="text-danger  d-inline-flex h3 col-lg-10">
                               <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil mt-2 mr-1" viewBox="0 0 16 16">
                             ...
                             <div class="col-lg-1 col-md-4 " >
                               <select  name="quiz" class=" js-example-basic-multiple " >
