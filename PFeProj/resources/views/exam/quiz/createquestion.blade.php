                ...
                <div class="row card-header bg-light">
                  <ul class="nav nav-tabs card-header-tabs col-lg-9">
                    <li class="nav-item">
                     ...
                     <strong>Question de rédaction (QR) </strong></button>
                    </li>
                    <li class="nav-item " >
                         ...
                         <div class="row">
                          <div class=" col-lg-10 ">
                            <button class="text-danger  d-inline-flex h3 col-md-9">
                              ...
                              </svg> Créer une nouvelle Question de rédaction :</button>
                            <div class="form-row mt-6">
                              <div class="row">
                                
                              <div class="col-md-10 mb-3">
                                  <label for="validationServer01" class="ml-3 mb-2 col-lg-8 col-md-4"><span class="text-danger"> *</span>Enoncé de la question : </label>
                            ...
                            <label  class="mb-2 ml-3" for = "file" ><span class="text-danger">*</span>Joindre un fichier à la question :</label ></br> 
                              ...
                              <div class="col-lg-12">
                                <div class="row">
                                  <div class="col-lg-4"></div>
                                                      <button style="margin-left: 20px;" class="col  col-md-4   btn btn-lg btn-danger text-white mt-2"  type="submit" value="Créer la question" name="create" >
                            ...
                            <div class="col-lg-1 col-md-4 " >
                              <label for="quiz[]" class="text-warning mb-2 mt-1" ><strong> Séléctionnez les quizs associés à la question :</strong></label>
                      ...
                      <form action="{{url('/questions') }}"  style="display: none" method="post" class="p-4 p-md-5 border border-danger  rounded-3  text-black font-weight-bold bg-light" name="frmqcm" id="asd2" onsubmit="return check_npointqcm()" >
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10 mb-3 mt-2">
                            ...
                            <div class="col-lg-2 " >
                              <label for="quiz[]" class="text-warning mb-2 mt-1 col-lg-12" ><strong> Séléctionnez les quizs associés à la question :</strong></label>
                              <select multiple="multiple" name="quiz[]" class="js-example-basic-multiple" >
                                @foreach ($quizes as $quiz)
